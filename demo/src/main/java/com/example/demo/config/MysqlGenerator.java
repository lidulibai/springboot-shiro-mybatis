...
public class MysqlGenerator {
    ...
    private static String packageName="service";    //文件路径
//    private static String authorName="Liang.Guangqing";     //作者
    private static String table="sys_test";                  //table名字
...
//                        .setAuthor(authorName)
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://192.168.99.100:3306/demo_test?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
